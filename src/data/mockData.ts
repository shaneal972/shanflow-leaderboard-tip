...
export const MOCK_TICKETS: TicketKLF[] = [
  {
    ...
    titre: 'Urgent : Décalage de calcul d\'Octroi de mer et figeage sur manifeste conteneurs',
    description: 'Bonjour le support. Mon classeur de suivi des arrivages maritimes n\'applique plus le taux d\'Octroi de mer (8.5% Guadeloupe) dès que j\'étire mes calculs vers le bas, et je perds mes titres de colonnes quand je fais défiler mes 800 lignes. La douane attend les déclarations avant 16h !',
    urgence: 'P2',
    points_valeur: 150,
    statut: 'ouvert',
  },
